        ...
        <section class="mt-6">
            <div class="glass-card p-4 flex flex-col md:flex-row items-center justify-between gap-4 relative overflow-hidden group border-white/5">
                ...
                <div class="flex items-center gap-4 relative z-10 w-full md:w-auto justify-between md:justify-end">
                    ...
                    <button onclick="window.open('https://t.me/intareservas_bot?start=${user.link_token || ''}', '_blank')" class="px-5 py-2 rounded-xl bg-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-[0.15em] hover:bg-emerald-500 hover:text-white transition-all shadow-lg border border-emerald-500/30">
                        Conectar
                    </button>
                </div>
            </div>
